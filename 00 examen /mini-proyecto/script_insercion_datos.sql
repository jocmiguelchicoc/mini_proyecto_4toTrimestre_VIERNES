...
VALUES ('Poesia'),
    ...
    ('Literatura');
-- AUTORES
INSERT INTO biblioteca.autores (nombre, nacionalidad)
VALUES ('Charles Bukowski', 'Estadounidense'),
...
VALUES (
        'Andres Felipe Castillo Moreno',
        'andres.castillo@gmail.com',
        '3001234567'
    ),
    (
        'Valentina Ospina Herrera',
        'vale.ospina@gmail.com',
        '3112345678'
    ),
    (
        'Santiago Vargas Bernal',
        'svargas@gmail.com',
        '3204567890'
    ),
    (
        'Daniela Cifuentes Roa',
        'dani.cifuentes@gmail.com',
        '3156789012'
    ),
    (
        'Juan David Pardo Acosta',
        'juanpardo@gmail.com',
        '3008901234'
    );
-- LIBROS
...
VALUES (1, 7, '2026-05-01', '2026-05-15', 'DEVUELTO'),
...
SET fecha_devolucion_real = '2026-05-14'
WHERE id_prestamo = 1;
UPDATE biblioteca.prestamos
SET fecha_devolucion_real = '2026-05-21'
WHERE id_prestamo = 6;